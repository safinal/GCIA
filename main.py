...
from exps import DFR, LossBasedExp, ClusterBasedExp, GCIA, EntropyBasedExp
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment', type=str, required=True, choices=['ERM', 'DFR', 'loss', 'cluster', 'entropy', 'gradcam', 'GCIA'])
